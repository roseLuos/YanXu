...
extension Color {
    ...
    static let yanxuWarningSoft = Color.adaptive(light: 0xFFF7ED, dark: 0x3A2E22)
    static let yanxuVioletSoft = Color.adaptive(light: 0xFAF5FF, dark: 0x332E48)
    static let yanxuSuccessSoft = Color.adaptive(light: 0xF0FDF4, dark: 0x243A31)
    static let yanxuArrivalIcon = Color.adaptive(light: 0xC38B5F, dark: 0xD3A475)
    static let yanxuDepartureIcon = Color.adaptive(light: 0x9683A8, dark: 0xB8A5C8)
    static let yanxuDurationIcon = Color.adaptive(light: 0x739B80, dark: 0x8CB49A)
